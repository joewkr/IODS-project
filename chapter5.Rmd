...
To get a better insight of the analyzed data set, probability density functions could be estimated for each of the variables:
...
This issues could be illustrated by the following plot:
...
The contributions of original variables provided on the figure for two almost orthogonal sets.
...
The second principal component which is connected to fraction of female members in parliament and participation in labour force of female population shows the involvement of the female population in the economic and political life.
...
The general overview of the `tea` data set could be give by the following series of the bar plots:
```{r, fig.align='center', fig.width = 8, fig.asp = 2.0}
...
```
This figure provides some interesting details about the tea drinking habits of respondents.
For example, most of the drink tea at home and do not add lemon or milk. 
