...
Although the worrying point there is the clusters of 35, 56 and 145 points having very close residual values.
...
Again on a seemingly reasonable plot the clusters of points holding the same value indicate potential issues with the model.
...
Our model seems to fit reasonably well under this assumption, though it still shows a cluster of 56 points.
But this cluster has a relatively low leverage value thus making it a bit less of an issue.
